                ...
                <div class="tab-content" data-aos="fade-up" data-aos-duration="1000">
                    <div class="tab-pane fade show active" id="pills-all" role="tabpanel"
                        ...
                        @if ($latestItems->count() > 0)
                            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xxl-4 g-3 items-grid-mobile">
                    ...
                    @foreach ($latestItemsCategories as $category)
                        <div class="tab-pane fade" id="pills-{{ $category->slug }}" role="tabpanel"
                            ...
                            @if ($category->items->count() > 0)
                                <div
                                    class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xxl-4 justify-content-center g-3 items-grid-mobile">
