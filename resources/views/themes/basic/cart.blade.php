        ...
        <div class="py-5">
            <div class="row g-4">
                <div class="col-12 col-lg-12 col-xxl-8">
                    <div class="card-v border card-bg p-4">
                        <div class="cart-item">
                            <div class="row g-3 justify-content-between">
                                ...
                                <div class="col-12 col-lg-auto">
                                    <form action="{{ route('cart.empty') }}" method="POST">
                                        @csrf
                                        <button class="btn btn-outline-danger w-100 action-confirm">
                        ...
                        @foreach ($cartItems as $cartItem)
                            ...
                            @endphp
                            <div class="cart-item">
                                <div class="row row-cols-auto align-items-sm-center flex-nowrap g-3">
                                    <div class="col">
                                        <a href="{{ $item->getLink() }}">
                                    ...
                                    <div class="col flex-shrink-1 flex-grow-1">
                                        <div class="mb-2">
                                            <div
                                                class="row row-cols-auto justify-content-between align-items-center g-3 flex-nowrap">
                                                <div class="col flex-shrink-1">
                                                    <a href="{{ $item->getLink() }}" class="cart-item-title mb-0">
                                                        <span>{{ $item->name }}</span>
                                                    </a>
                                                </div>
                                        ...
                                        <div>
                                            <div class="row row-cols-auto justify-content-between align-items-center g-2">
                                                <div class="col">
                                                    <form action="{{ route('cart.update-item', $cartItem->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        <div class="row g-3 align-items-center">
                                                            ...
                                                            <div class="col-auto">
                                                                <div class="row g-1 align-items-center">
                                                                    <div class="col-auto">
                                                                        <label
                                                                            class="col-form-label">{{ translate('Quantity') }}</label>
                                                                    </div>
                                                                    <div class="col">
                ...
                <div class="col-12 col-lg-12 col-xxl-4">
                    <div class="card-v border card-bg text-center p-4">
                        <h4 class="mb-4">{{ translate('Your Cart Total') }}</h4>
                        <p class="h1 mb-4">{{ getAmount($cartTotal, 2) }}</p>
        ...
        <div class="card-v card-bg">
            <div class="card-body text-center">
                <div class="py-5">
                    <div class="mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="150px" height="150px"
                            ...
                            <path
                                ...
                                transform="translate(-152 -76.01429)" fill="{{ $themeSettings->colors->primary_color }}" />
                    ...
                    <h4 class="mb-3">{{ translate('Your Cart is Empty') }}</h4>
                    <p>
