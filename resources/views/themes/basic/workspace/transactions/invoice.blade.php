                ...
                <table class="invoice-table">
                    ...
                    <tbody>
                            ...
                            @if ($trx->trxItems->count() > 0)
                                @foreach ($trx->trxItems as $trxItem)
                                    ...
                                    @if ($trxItem->support)
                                        <tr class="card-bg">
                                            <td>
                                                <p class="mb-0">{{ $trxItem->support->title }}</p>
                                            </td>
                                            <td class="text-center">{{ getAmount($trxItem->support->price) }}</td>
                                            <td class="text-center">{{ $trxItem->support->quantity }}</td>
                                            <td class="text-end">{{ getAmount($trxItem->support->total) }}</td>
                                        </tr>
                                    @endif
                                @endforeach
                            @endif
                        @elseif($trx->isTypeSupportPurchase() || $trx->isTypeSupportExtend())
                            <tr>
                                <td>
                                    <p class="mb-0">{{ $trx->support->title }}</p>
                                </td>
                                <td class="text-center">{{ getAmount($trx->support->price) }}</td>
                                <td class="text-center">{{ $trx->support->quantity }}</td>
                                <td class="text-end">
                        ...
                        @elseif($trx->isTypeDeposit())
                            <tr>
                                <td>
                                    <p class="mb-0">{{ translate('Deposit to account balance') }}</p>
                                </td>
